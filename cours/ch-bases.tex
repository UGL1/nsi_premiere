...
\end{methode}
\'Evidemment, \textsc{Python} connait le binaire. Voici comment écrire un \pythoninline{int} en binaire et comment obtenir l'écriture
binaire d'un \pythoninline{int}.
\begin{pys}
    \begin{minted}{python}
