...
\floatpictureleft{0.2}{img/joke1}{
...
\end{methode}
\'Evidemment, \textsc{Python} connait le binaire et travaille avec des valeurs entières de type \mintinline{python}{int} (\textit{integer} veut dire « entier » en Anglais, pour plus de précisions, voir le chapitre \ref{ch:types}, partie \ref{sec:int} ).\\
...
\floatpictureleft{0.4}{img/bitjoke}{
    ...
    Le bit est \og le plus petit morceau d'information numérique \fg{}.
}\medskip\par
